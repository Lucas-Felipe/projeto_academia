...
VALUES (1, '2019/11/10', 'cartão', 70, '01524856930'),
       ...
       (5, '2020/02/28', 'débito em conta', 65, '00789665603'),
       (6, '2020/03/28', 'débito em conta', 65, '00789665603'),
...
INSERT INTO FICHAS (id_ficha, n_repeticoes, n_series, peso, a_cpf)
VALUES (00001, 12, 5, 10.5, '25864831550'),
        (00011, 10, 3, 8.5, '12598654712'),
        (00012, 15, 4, 15, '12598654712'),
        (00002, 10, 3, 8.5, '25864831550'),
        (00003, 12, 3, 10, '00789665603'),
        (00006, 15, 4, 15, '01047856610'),
        (00004, 20, 4, 10.5, '00789665603'),
        (00005, 30, 3, 12.5, '01047856610'),
        (00007, 25, 3, 15, '18203648709'),
        (00008, 15, 4, 20, '18203648709'),
        (00009, 12, 5, 10, '01524856930'),
        (00010, 20, 4, 12, '01524856930'),
        (00013, 25, 3, 8.5, '00885423642'),
        (00014, 30, 3, 9, '00885423642');
...
INSERT INTO CONTEM (id_ficha, id_exercicio)
VALUES (00001, 06), 
       (00001, 04), 
       (00002, 01), 
       (00002, 03), 
